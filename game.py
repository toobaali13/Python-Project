...
class Game(object):
    def __init__(self):
        ...
        self.hiscore = f.read()
        f.close()
        # Create the font for displaying the high score on the screen
        ...
        self.enemies.add(Slime1(288,320,0,-2))
        self.enemies.add(Slime2(544,128,0,2))
        self.enemies.add(Slime3(32,224,0,2))
        self.enemies.add(Slime(160,64,2,0))
        self.enemies.add(Slime1(448,64,-2,0))
        self.enemies.add(Slime2(640,448,2,0))
        self.enemies.add(Slime3(448,320,2,0))
    ...
    def run_logic(self):
        if not self.game_over:
            ...
            if len(block_hit_list) > 0:
                ...
                self.score += 1
                #if is greater than high sacore it will became high score
    ...
    def display_frame(self,screen):
        ...
        if self.game_over:
            #to store highest score in game
            f = open("hiscore.txt",'w')
            f.write(str(self.hiscore))
            f.close()
            if self.about:
                self.display_message(screen,"Pac-Man is an action maze chase video game.")
            ...
            text = self.font.render("Score: " + str(self.score) + "  High Score: " + str(self.hiscore),True,GREEN)
